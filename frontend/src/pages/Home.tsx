...
export default function Home() {
  return (
    <div className="mx-auto w-full bg-slate-200 h-full pb-24">
      <div className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-1 sm:py-16 bg-slate-200 h-full">
